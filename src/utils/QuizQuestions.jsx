const QuizQuestions = [
	...
	},
	{
		...
		answers: [
			...
			"It releases toxins into the environment",
			"It uses a lot of water",
		],
		correctAnswer: "It is an expensive material",
		reasoning:
	...
	//     reasoning:"Conventional cotton uses up to 25% of all the pesticides used in farming",
	//     winAmount: 1500,
	//     loseAmount: -700,
	// },
