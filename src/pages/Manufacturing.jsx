...
function Manufacturing() {
    ...
    // Preload all models
    const preloadedFactoryModels = useLoader(
        GLTFLoader,
        Manufacturers.map((model) => model.model),
        (loader) => {
    ...
    const [selectedFactoryModel, setSelectedFactoryModel] = useState(
        ...
        <div className="app">
            <Suspense fallback={<Loader />}>
                ...
                <div className="canvas-container">
                    ...
                    >
                        <Experience
                            ...
                            preloadedModels={preloadedFactoryModels}
                        />
                    </Canvas>
                    ...
                    <div className="details-container">
                        ...
                        <div className="outfit-details">
                            <SelectionPanel
                                currentStep={4}
                                selectedModel={selectedFactoryModel}
                                setSelectedModel={setSelectedFactoryModel}
                            />
                        </div>
                    </div>
                </div>
                <div className="model-list-container">
					<ModelList
						selectedModel={selectedFactoryModel}
						onModelChange={setSelectedFactoryModel}
