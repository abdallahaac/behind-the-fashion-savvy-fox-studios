        ...
        <div className="tutorial-overlay">
            <div className="tutorial-box">
                ...
                <button
                    ...
                    style={{
                        backgroundColor: currentVideoIndex >= videos.length && !isBudgetRolled ? '#cccccc' : '#C83C00',
                        cursor: currentVideoIndex >= videos.length && !isBudgetRolled ? 'not-allowed' : 'pointer'
                    }}
                >
                ...
                <div className="pagination-bar">
                    ...
                    <div
                        className={`pagination-dot ${currentVideoIndex === videos.length ? 'active' : ''}`}
                    ></div>
                </div>
            </div>
        </div>
